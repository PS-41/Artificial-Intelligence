...
# print(y_pred)
# print(confusion_matrix(y_test, y_pred))
# print("Accuracy Kshitiz = ", accuracy_score(y_test, y_pred))
# print()

data = pd.read_csv('Prakhar.csv')
col_names = list(data.columns.values)
# data = data.drop(col_names[: 674], axis = 1) # Dropping all non AU columns
# data = data.sample(frac = 1).reset_index(drop = True)
col_names = list(data.columns.values)
...
print(y_pred)
print(confusion_matrix(y_test, y_pred))
print("Accuracy Prakhar = ", accuracy_score(y_test, y_pred))
print()

# data = pd.read_csv('Sandesh.csv')
# col_names = list(data.columns.values)
# data = data.drop(col_names[: 674], axis = 1) # Dropping all non AU columns
# # data = data.sample(frac = 1).reset_index(drop = True)
# col_names = list(data.columns.values)
...
# print(y_pred)
# print(confusion_matrix(y_test, y_pred))
# print("Accuracy Sandesh = ", accuracy_score(y_test, y_pred))
# print()

# data = pd.read_csv('Shivi.csv')
# col_names = list(data.columns.values)
# data = data.drop(col_names[: 674], axis = 1) # Dropping all non AU columns
# # data = data.sample(frac = 1).reset_index(drop = True)
# col_names = list(data.columns.values)
...
# print(y_pred)
# print(confusion_matrix(y_test, y_pred))
# print("Accuracy Shivi = ", accuracy_score(y_test, y_pred))
# print()
